  ...
  return (
    ...
    >
      <Stack direction="row" mb={1} justifyContent="space-between" alignItems="center">
        <Box color="white">
          <Typography variant="body2"># of Project Owners</Typography>
      ...
      <Stack spacing={0.5} mt={2}>
        ...
        <Stack borderRadius={2} bgcolor={antColors.blue[0]} direction="row" justifyContent="space-between" px={2} py={1} color="grey">
          <Stack direction="row" spacing={1.2}>
            ...
            <Typography>Approved (kyc)</Typography>
          </Stack>
        ...
        <Stack borderRadius={2} bgcolor={antColors.blue[0]} direction="row" justifyContent="space-between" px={2} py={1} color="grey">
          <Stack direction="row" spacing={1.2}>
            ...
            <Typography>Pending (kyc)</Typography>
          </Stack>
        ...
        <Stack borderRadius={2} bgcolor={antColors.blue[0]} direction="row" justifyContent="space-between" px={2} py={1} color="grey">
          <Stack direction="row" spacing={1.2}>
            ...
            <Typography>Rejected (kyc)</Typography>
          </Stack>
...
export default ProjectOwnersCard;
